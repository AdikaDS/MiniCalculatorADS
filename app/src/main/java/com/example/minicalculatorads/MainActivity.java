        ...
        buttonTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (angkaPertama.getText().length()>0 && angkaKedua.getText().length()>0 ) {
                    ...
                    Toast toast = Toast.makeText(MainActivity.this,"Masukkan Angka",Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
        });
            ...
            public void onClick(View view) {
                if (angkaPertama.getText().length()>0 && angkaKedua.getText().length()>0 ) {
                    ...
                    if (b != 0) {
                        ...
                        Toast toast = Toast.makeText(MainActivity.this,"Masukkan Angka yang Benar !",Toast.LENGTH_SHORT);
                        toast.show();
                    }
                }
                else {
